...
$w='SELECT sl_no,name,email_id,phone,branch,word_count,amount,subject,report FROM reporter WHERE branch like "%'.$branch.'%" ;';
...
<li><a href="branch.php">Home</a></li>
...
<tr>
<td ><?php echo $r ?></a></td>
<td><?php echo '<a href="inf.php?a2='.$r.'" >'. " $d ".'</a>'; ?></td>
<td><?php echo $e ;?></td>
<td><?php echo $q ;?></td>
<td><?php echo $b ;?></td>
<td><?php echo $h ;?></td>
...
{
 echo 'No such entries';
 header('Location: reporteradmin.php');} 
