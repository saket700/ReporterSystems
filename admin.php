...
<p><label for="show">Show:</label><br><br>
<input type="text"  class="form-control" readonly placeholder="3" id = "show" name="show" required></p><br>
  </div>
...
$w = 'SELECT Sl_no,name,email_id,phone,branch,`group` FROM admin_user LIMIT '.$startrow.',3';
...
<td><?php echo $h ?></td>
<td><?php echo $k ?></td>
<td> <?php echo  '<a  href="edit_admin.php?no='.$e.'">'?><img src="pencil.png" /><?php   '</a>';?>&nbsp;|&nbsp;<?php echo' <a href="admin_delete.php?no1='.$r.'">'?><img src="cross.png" /> <?php '</a>';?></td>
</tr>
<?php    
