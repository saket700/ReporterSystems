...
if($totalrows>0)
{
	do
{
	$wc=$row_recordset['word_count'];
	$wr= $row_recordset['word_rate'];
...
<p><label for="Word count">Word Count Conversion: </label><br><br>

<input type="text" class="form-control" value="<?php echo $wc;?>" name="word_count"></p></div>


<div class="form-group col-lg-4">
<p><label for="Description">Word Rate Conversion:</label><br><br>
<input type="text" class="form-control" value="<?php echo $wr;?>" name="word_rate"></p></div>
<br>


<div class="form-group col-lg-12">
<input type="submit"  class="btn btn-default" value="Submit" ></p></div><br>
