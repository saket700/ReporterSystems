...
<hr>
<form  role="form"  action ="search_branchadmin.php" method="post">
...
<form role="form" action="adminadd_branchadmin.php" method="post">

<div class="form-group col-lg-12">
<input type="submit"  class="btn btn-default" value="Add Branch Admin" onClick="href 'adminadd_branchadmin.php' " ></p>
</div>
</form>
...
$w='SELECT Sl_no,name,branch,phone,email_id,`group`  FROM admin_user WHERE `group` = "branchadmin" LIMIT '.$startrow.'3' ;
...
do
{
	...
	$e= $row_recordset['branch'];
	$q=$row_recordset['phone'];
	$h= $row_recordset['email_id'];
...
<tr>
<td ><?php echo $r ?></a></td>
<td><?php echo '<a href="inf.php?a2='.$h.'" >'. " $d ".'</a>'; ?></td>
<td><?php echo $e ?></td>
<td><?php echo $q ?></td>
<td><?php echo $h ?></td>
