...
$eid=$_REQUEST['a'];
$w= 'SELECT report,date from reporter WHERE email_id="'.$eid.'"  ;';
...
<textarea name="report" type="text area" cols="60" rows="8"class="form-control" placeholder="<?php echo $r;?>" ></textarea></p><br> <br><br></div>
<?php
