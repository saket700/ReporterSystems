...
$wc=$_REQUEST['word_count'];
$wr=$_REQUEST['word_rate'];
...
if($totalrows>0)
{
$w1= 'UPDATE settings set word_count="'.$wc.'" , word_rate="'.$wr.'";';
$x=$recordset=mysql_query($w1,$a1) or die(mysql_error());
if($x==1)
{
	echo "New word count updated succesfully";
}
else
...
{ 
$w1= 'INSERT into settings ( word_count, word_rate) VALUES ("'.$wc.'","'.$wr.'");';
$x=$recordset=mysql_query($w1,$a1) or die(mysql_error());
if($x==1)
{
	echo " word count insertion successful";
}
else
{ 
