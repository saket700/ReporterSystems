...
$w = 'SELECT date,subject from reporter where report="'.$report.'";';
...
?>
<form method="post" action="insertrate.php">
<input type="hidden" name="hidden" value="<?php echo $sub;?>">
<p><label for="date">Date</label><br><br>
<input type="text"  class="form-control" readonly placeholder="<?php echo $date;?>" id = "date" name="date" ></p><br></div>
<div class="form-group col-lg-4">
<p><label for="report">Report </label><br><br>
<textarea name="report" type="text area" cols="60" rows="8"class="form-control" placeholder="<?php echo $report;?>" ></textarea></p><br> <br><br></div>
<div class="form-group col-lg-4">
  <p><label for="name">RATING:</label><br><br>
  <input type="text"  class="form-control" placeholder="Rate out of 10" id = "name" name="rate" required></p><br>
  </div>
  <div class="form-group col-lg-12"><input type="submit"  class="btn btn-default" value="Rate" ></div></div>
 </div>
