...
if($totalrows>0)
{
 do
 {
	...
	$des1=$row_recordset['description'];
...
<input type="text" class="form-control"  placeholder=" Branch Name" name="bname"></p><br></div>
<div class="form-group col-lg-4">
<p><label for="Description">Description:</label><br><br>
<input type="text" class="form-control" placeholder=" Description" name="descp"></p><br></div>
<div class="form-group col-lg-12">
<input type="submit"  class="btn btn-default" value="Add Branch" ></p><br></div>
</div>
</div>
</div>
</form>
...
exit(0);
	...
	$w1='INSERT into create_branch(branch,description) VALUES("'.$bn.'","'.$des.'")';
