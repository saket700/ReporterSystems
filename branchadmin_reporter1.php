...
<?php
$w='SELECT Sl_no,name,email_id,phone,subject,word_count,rating,report FROM reporter WHERE branch="'.$br.'";' ;
...
<td><?php echo $e ;?></td>
<td ><?php echo $ph ;?></td>
<td><?php echo '<a href="branchadmin_disreport.php?report='.$report.'">'."$sub".'</a>'; ?></td>
<td><?php echo $wc ;?></td>
<td><?php echo $ra ;?></td>
<td> <?php echo' <a href="branchadminreporter_delete.php?no1='.$e.'">'?><img src="cross.png" /> <?php '</a>';?></td>
