...
<input type="text" class="form-control" placeholder=" <?php echo $bn ;?>" name="bname"></p><br></div>
...
exit(0);
	...
	$w1='UPDATE create_branch set branch="'.$bn.'", description="'.$d.'" WHERE Sl_no="'.$sn.'";';
