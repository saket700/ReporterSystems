...
$s=$_REQUEST['no'];
$w='SELECT branch,description FROM create_branch WHERE Sl_no="'.$s.'";';
...
<input type="text" class="form-control" value= " <?php echo $r; ?>"  name="bname" ></p><br></div>

<div class="form-group col-lg-4">
<p><label for="Description">Description:</label><br><br>
<input type="text" class="form-control" value=" <?php echo $d; ?>" name="descp" ></p><br></div>
