...
$w='SELECT Sl_no,name,email_id,phone,branch FROM admin_user  WHERE `group`="branchadmin" and branch like"%'.$br.'%"LIMIT '.$startrow.'3';
...
<?php    
	...
	echo "NO BRANCHADMIN IN SUCH BRANCH EXISTS";}
