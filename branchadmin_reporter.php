...
<li><a href="branchadmin_reporters.php">Reporters</a></li>
...
$w='SELECT Sl_no,branch,count(*) FROM admin_user WHERE `group`="reporter" GROUP BY branch  LIMIT '.$startrow.'3' ;
...
<tr>
<td ><?php echo $r ?></a></td>
<td><?php echo '<a href="branchadmin_reporter1.php?a2='.$d.'" >'. " $d ".'</a>'; ?></td>
<td><?php echo $e ?></td>
